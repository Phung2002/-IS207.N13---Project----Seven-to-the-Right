...
class cartDAO
{
    ...
    public function getAllData($id)
    {
        ...
        $query = 'select * from transactions where id_user=:id';
        $param = array(':id' => $id);
    ...
    {
        $dbConn = new configuration();
        $query = 'select * from transactions where id_product=:id and id_user=:id_user';
    ...
    {
        $dbConn = new configuration();
        $query = 'insert into transactions(id_user,id_product) values (:id_user,:id_product)';
    ...
    {
        $dbConn = new configuration();
        $query = 'delete from transactions where id_user=:user_id';
    ...
    {
        $dbConn = new configuration();
        $query = 'insert into order(id_order,id_product,id_user) values (:id_order,:id_product,:user_id)';
    ...
    {
        $dbConn = new configuration();
        $query = 'select MAX(id_order) from order';
        $param = array();
    ...
    {
        $dbConn = new configuration();
        $query = 'delete from transactions where id_product=:id and id_user=:user_id';
