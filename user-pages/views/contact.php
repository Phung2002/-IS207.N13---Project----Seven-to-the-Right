		...
		<div class="container">
			<div class="row">
				<div class="col-md-9 clearfix">
					...
					<div class="block">
						<div class="">
							<b class="name ng-binding">PHTN Store</b>
						</div>
						<div class="">
							<i class="fas fa-map-marker"></i>
							<b>Địa chỉ:</b>Đường Hàn Thuyên, khu phố 6, phường Linh Trung, TP Thủ Đức, TP.HCM
						</div>
						<div class="">
							<i class="fas fa-phone"></i>
							<b>Điện thoại:</b> (+84) 0123 456 789
						</div>
						<div class="">
							<i class="fas fa-mobile"></i>
							<b>Hotline</b> (+84) 0123 456 789
						</div>
						<!-- <div class="">
						...
						<div class="">
							...
							<a href="mailto:info@runtime.vn" class="ng-binding">20520535@gm.uit.edu.vn</a>
						</div>
					</div>
					<hr class="">
					<h3 class="title">Gửi thông tin liên hệ</h3>
					<div class="">
						Nếu bạn có bất kỳ thắc mắc nào, xin vui lòng điền các yêu cầu vào mẫu dưới đây và gửi cho chúng tôi. 
