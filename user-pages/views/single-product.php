				...
				<div class="col-md-5">
					<div class="single-product-img">
						<img src="../../imgs/<?php
											...
											?>" alt="" width="450px" style="object-fit: contain; height: 373px"></img>
				...
				<div class="col-md-4">
					<div class="block">
						<div class="product-des">
							...
							echo '<h4>' . $product->getClothes_name() . '</h4>';
							echo '<p class="price">' . number_format($product->getPrice()) . 'đ</p>';
							echo '<h5> <b> Kích cỡ ' . $product->getClothes_descripsion() . '</b></h5>'; 
							?>
	
								
		
			<div class="product-form__item" style=" display: flex; ">
				<label class="header">  <p>&nbsp</p>   <span class="slVariant"></span></label>
