							...
							<div class="col-25">
								<div class="container-checkout">
									...
									<?php foreach ($list_item as $product) {
										echo '
									<p><h5>' . $product[0]->getClothes_name() . '<span class="pricee">' . number_format($product[0]->getPrice()) . ' đ</span><span style="float: right; padding-right: 10%;">x'.$product[1].'</span><h5></p>';
									} ?>
									<hr>
									<p>
