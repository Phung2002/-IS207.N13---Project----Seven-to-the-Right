                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="title"><?php
                                                    ...
                                                    ?> <a href="../views/item-editor.php?menu=clothes&item=<?php echo $item ?>" class="btn btn-primary btn-sm rounded-s"> Thêm sản phẩm</a>
                                    <!--
				 -->
                                ...
                                <div class="item-col fixed pull-left item-col-title">
                                    ...
                                    <div>
                                        <a href="../controller/productsController.php?action=getProduct&id=' . $prd->getId() . '" class="">
                                            <h4 class="item-title"> ' . $prd->getClothes_name() . ' </h4>
                                        </a>
                                    </div>
                                </div>
                                <div class="item-col fixed pull-left item-col-title">
