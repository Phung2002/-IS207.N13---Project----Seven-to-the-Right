        ...
        <div class="app" id="app">
            ...
            <article class="content item-editor-page">
                <div class="title-block">
                    <h3 class="title"> Sản phẩm <span class="sparkline bar" data-type="bar"></span>
                    </h3>
                </div>
                <form name="itemClothes" method="POST" onsubmit="return formClothes_Validate();" action="../controller/productsController.php<?php if (isset($prd)) {
                                                                                                                                            echo '?id=' . $prd->getId();
                                                                                                                                        } else {
                                                                                                                                            echo '';
                    ...
                    <div class="card card-block">
                        <div class="form-group row has-warning">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control boxed" placeholder="Nhập tên sản phẩm" name="title" value="<?php if (isset($prd)) {
                                                                                                                                    echo $prd->getClothes_name();
                                                                                                                                } else {
                                                                                                                                    echo '';
                                                                                                                                } ?>">
                            ...
                            <div class="col-sm-10">
                                <div class="wyswyg">
                                    <textarea name="decripsion" rows="5" class="form-control boxed" placeholder="Nhập nội dung"><?php if (isset($prd)) {
                                                                                                                                    echo $prd->getClothes_descripsion();
                                                                                                                                } else {
                                                                                                                                    echo '';
                                                                                                                                } ?></textarea>
                                </div>
