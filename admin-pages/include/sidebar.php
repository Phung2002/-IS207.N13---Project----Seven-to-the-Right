    ...
    <div class="sidebar-container">
        ...
        <nav class="menu">
            <ul class="sidebar-menu metismenu" id="sidebar-menu">
                ...
                echo '    <a href="">
                                    <i class="fa fa-th-large"></i> Danh mục quần áo<i class="fa arrow"></i>
                                </a>
                                <ul class="sidebar-nav">';
                foreach ($list_cate as $value) {
                    if ($value->getId() == $item && $menu == 'clothes') echo ' <li class="active open">';
                    else echo '<li>';
                    echo '<a href=""><i class="fa fa-chevron-right"></i>&nbsp;&nbsp;' . $value->getCategory_name() . ' <i class="fa arrow"></i>
                                        </a>
                                        <ul class="sidebar-nav">
                                            <li><a class="edit" href="../views/itemtittle-editor.php?menu=clothes&item=' . $value->getId() . '" onclick="<?php $_SESSION[\'menu\']=\'clothes\' ?>">
                                            <i class="fa fa-pencil"></i>&nbsp&nbsp&nbspChỉnh sửa danh mục </a>
                                            </li>
                                            <li><a class="remove" href="../controller/categoriesController.php?menu=clothes&item=' . $value->getId() . '&action=delCate"><i
                                                        class="fa fa-trash-o "></i>&nbsp&nbsp&nbspXoá danh mục </a></li>
                                            <li><a href="../controller/productsController.php?item=' . $value->getId() . '&menu=clothes"><i
                                                        class="fa fa-plus"></i>&nbsp&nbsp&nbspXem chi tiết </a></li>
                                        </ul>
                                    </li>';
                }
                if ($item == -1 && $menu == 'clothes')
                    echo ' <li class="active open">';
                else echo '<li>'; ?>
                <a href="../views/itemtittle-add.php?menu=clothes&item=-1"><i class="fa fa-plus"></i> &nbspThêm danh mục </a>
                </li>
            </ul>
            <?php if ($menu == 'recipe')
                echo ' <li class="active open">';
